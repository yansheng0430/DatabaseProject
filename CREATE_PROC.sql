...
CREATE FUNCTION GetCategoryTypeMapID (@Category NVARCHAR(20))
RETURNS NVARCHAR(3)
BEGIN
...
CREATE PROC GetContainsByOrderID @OrderID NVARCHAR(15)
AS
	SELECT CONTAIN.ISBN, BName, UnitPrice, CONTAIN.Quantity
	FROM CONTAIN JOIN BOOK ON CONTAIN.ISBN = BOOK.ISBN
